...
import ${packageName}.domain.enumeration.RequestType;
...
import io.github.jhipster.web.util.ResponseUtil;\n`]}, this);
        ...
        // Write blockchain requests functions in REST controller
        jhipsterUtils.rewriteFile({
            file: `${javaDir}web/rest/RequestResource.java`,
            needle: '}',
            splicable: [`	/**
